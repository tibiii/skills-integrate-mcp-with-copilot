document.addEventListener("DOMContentLoaded", () => {
  ...
  // messageDiv already declared above
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        activityCard.innerHTML = `
          ...
          <form class="inline-signup-form" data-activity="${name}">
            <input type="email" class="inline-email" placeholder="your-email@mergington.edu" required />
  ...
  async function handleInlineSignup(event) {
    ...
    const emailInput = form.querySelector(".inline-email");
